        ...
        <%@ taglib prefix="fmt" uri="jakarta.tags.fmt" %>
            ...
            <body>
                <main class="main">
                    ...
                    <div class="content">
                        ...
                        <div class="thongke-container">
                            ...
                            <div class="filter-bar">
                                ...
                                <select name="yearFiler" id="yearSelect" class="form-control"
                                    style="display: ${type == 'year' ? 'block' : 'none'};">
                                ...
                                <form action="ThongKe" method="get" id="dateSelect"
                                    style="display: ${type == 'year' ? 'none' : 'flex'};">
                                    <div class="date-filter">
                                        <label for="fromDate">Từ ngày:</label>
                                        <input type="date" name="fromDate" id="fromDate" value="${from}" max=""
                                            required>
                                    </div>
                                    <div class="date-filter">
                                ...
                                <button type="button" class="buttonSearch" onclick="exportExcel()"
                                    style="margin-left: 10px; background-color: #28a745; padding: 10px 15px; border: none; color: white; cursor: pointer; border-radius: 4px; font-weight: bold; height: fit-content; align-self: center;">Xuất
                                    Excel</button>
                            </div>
                            <div id="thongke-content">
                                <div class="cards" id="cards">
                                    ...
                                    <div class="card sold-books-card">
                                        <i class="fa-solid fa-chart-line"></i>
                                        <h3>Sách bán được theo kỳ</h3>
                                        <p>${top10Books.size()} đầu sách</p>
                                    </div>
                                    <div class="card unsold-books-card">
                                        <i class="fa-solid fa-book-open"></i>
                                        <h3>Sách chưa bán được</h3>
                                        <p>${unsoldBooks.size()} đầu sách</p>
                                    </div>
                                </div>
                                <div class="chart-container">
                                    <div class="chart">
                                        <h2>Biểu đồ doanh thu</h2>
                                        <canvas id="revenueChart" data-type="${type}" data-labels='[
                                    ...
                                    <div class="chart">
                                        ...
                                        <canvas id="orderLineChart" data-type="${type}" data-labels='[
                                    ...
                                    <div class="chart-row">
                                        <div class="chart-pie">
                                            ...
                                            <canvas id="categoryPieChart" data-type="${type}" data-labels='[
                                        ...
                                        <div class="chart-line">
                                            ...
                                            <canvas id="profitByCategoryPieChart" data-type="${type}" data-labels='[
                                    ...
                                    <tbody id="userTable">
                                        <c:forEach items="${top10Customers}" var="c">
                                            <tr class="infUser">
                                                ...
                                                <td>${c.point}</td>
                                                <td>
                                                    <fmt:formatNumber value="${c.totalSpent}" type="number"
                    ...
                    <div id="sold-books-panel">
                        <div id="sold-books-container">
                            <div class="panel-header">
                                <h3><i class="fa-solid fa-chart-line"></i> Sách bán được trong kỳ</h3>
                                <span class="panel-close" onclick="document.getElementById('sold-books-panel').style.display='none'">&times;</span>
                            </div>
                            <div class="table-wrapper">
                                <table>
                                    <thead>
                    ...
                    <div id="unsold-books-panel">
                        <div id="unsold-books-container">
                            <div class="panel-header">
                                <h3><i class="fa-solid fa-book-open"></i> Sách chưa bán được</h3>
                                <span class="panel-close" onclick="document.getElementById('unsold-books-panel').style.display='none'">&times;</span>
                            </div>
                            <div class="table-wrapper">
                                <table>
                                    <thead>
            ...
            <script>
                document.addEventListener("click", function (e) {
                    ...
                    if (e.target.closest(".sold-books-card")) {
                        document.getElementById("sold-books-panel").style.display = "flex";
                    }

                    if (e.target.closest(".unsold-books-card")) {
                        document.getElementById("unsold-books-panel").style.display = "flex";
                    }
                    ...
                    if (e.target.id === "sold-books-panel") {
                        e.target.style.display = "none";
                    }

                    if (e.target.id === "unsold-books-panel") {
                        e.target.style.display = "none";
                    }
                });
            </script>
                ...
                function loadThongKe(url) {
                    fetch(url)
                        ...
                        .then(html => {
                            ...
                            let sp = doc.querySelector("#sold-books-panel");
                            if (sp) document.querySelector("#sold-books-panel").innerHTML = sp.innerHTML;

                            let up = doc.querySelector("#unsold-books-panel");
                            if (up) document.querySelector("#unsold-books-panel").innerHTML = up.innerHTML;
