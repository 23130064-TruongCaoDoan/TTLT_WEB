        ...
        <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
            <%@ taglib prefix="fmt" uri="jakarta.tags.fmt" %>
                ...
                <head>
                    ...
                    <link rel="preconnect" href="https://fonts.googleapis.com">
                    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
                    <link href="https://fonts.googleapis.com/css2?family=Bungee&family=Lobster&display=swap"
                        rel="stylesheet">
                ...
                <body>
                    <div class="page-wrapper">
                        ...
                        <main>
                                    ...
                                    <div class="gallery">
                                        <div class="thumbnail-column">
                                            <c:forEach items="${listImg}" var="img" varStatus="st">
                                                <img class="thumbnail ${st.first ? 'active' : ''}" src="${img}"
                                                    alt="Ảnh sách ${st.index + 1}" data-main-image="${img}">
                                            </c:forEach>
                                        </div>
                                        ...
                                        <div class="price-cart">
                                            <div class="price">
                                                <c:if test="${book.priceDiscounted > 0}">
                                                    ...
                                                    <p>
                                                        <fmt:formatNumber value="${book.priceDiscounted}" type="number"
                                                            groupingUsed="true" maxFractionDigits="0" /> Đ
                                                    </p>
                                                </c:if>
                                                <c:if test="${book.priceDiscounted == 0}">
                                                ...
                                                <div class="quantity" style="padding-top: 10px;">
                                                    <div class="number-input">
                                                        ...
                                                        <input type="number" name="quantity" value="1" min="1"
                                                            max="${book.stock}" id="number-quantity"
                                                            class="no-spinners" />
                                                        <button type="button" class="plus" onclick="plus()">+</button>
                                                    </div>
                                                </div>

                                                <button type="button" id="cart" onclick="addToCartDetail()">Thêm vào giỏ
                                                    hàng<i class="fa-solid fa-cart-plus"></i></button>
                                            </form>
                                            ...
                                            <span>
                                                <i id="addHeart"
                                                    class="fa-solid fa-heart ${isFavouriteBook ? 'active' : ''}"
                                                    onclick="toggleFavourite(${book.id})"></i>
                                            </span>
                                        </div>
                                        <div class="program">
                                                    ...
                                                    <div>
                                                        ...
                                                        <c:if test="${isStaff}">
                                                            <input type="checkbox" ${cmt.active ? "checked" : "" }
                                                                data-id="${cmt.id}" onchange="toggleActive(this)">
                                                        </c:if>
                                                    </div>
                                                </div>
                            ...
                            <div class="recommend">
                                <div class="slogan">
                                    <h3>Chúng tôi coi trọng chất lượng và sự độc đáo</h3>
                                </div>
                                ...
                                <div class="slogan">
                                    <h3>Những quyển sách có thể bạn sẽ thích</h3>
                                </div>
                                                ...
                                                <div class="price-cart">
                                                    <p class="price"
                                                        ...
                                                        <c:if test="${book.priceDiscounted > 0}">
                                                            ...
                                                            <span>
                                                                <fmt:formatNumber value="${book.priceDiscounted}"
                    ...
                    <script>
                        ...
                        function launchFloatingHearts(heart) {
                            const rect = heart.getBoundingClientRect();
                            const colors = ["#e53935","#f06292","#ff80ab","#e91e63","#ff4081","#ff6d6d"];
                            for (let i = 0; i < 6; i++) {
                                setTimeout(() => {
                                    ...
                                    const startY = rect.top + rect.height / 2 + (Math.random() - 0.5) * 10;


                                    const size = 16 + Math.random() * 18;
                                    const dur  = 0.9 + Math.random() * 0.5;
                                    const sway1 = (Math.random() - 0.5) * 30;
                                    const sway2 = (Math.random() - 0.5) * 50;
                                    const sway3 = (Math.random() - 0.5) * 40;
                                    ...
                                    h.style.setProperty("--sway1", sway1 + "px");
                                    h.style.setProperty("--sway2", sway2 + "px");
                                    h.style.setProperty("--sway3", sway3 + "px");
                        ...
                        function toggleFavourite(bookId) {
                            ...
                            fetch(url, {
                                ...
                                .finally(() => {
                                    isProcessing = false;
                                    setTimeout(() => heart.classList.remove("heart-pop"), 450);
                                });
                        }
